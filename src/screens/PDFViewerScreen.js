...
import { StyleSheet, View, Text, ActivityIndicator, TouchableOpacity, Alert, Dimensions, SafeAreaView, StatusBar, Platform } from 'react-native';
...
const PDFViewerScreen = () => {
  ...
  const { pdfUri, fileName, loadPDF, clearPDF } = usePDF();
      ...
      <View style={styles.container}>
        ...
        {!base64Content ? (
          <View style={styles.placeholderContainer}>
            ...
            <TouchableOpacity 
              style={[styles.pickButton, styles.placeholderButton]} 
              onPress={pickDocument}
            >
              <Text style={styles.pickButtonText}>Select PDF</Text>
            </TouchableOpacity>
